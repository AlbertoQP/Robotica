...
namespace rc
{
    ...
    public:
        ...
        PreObject(const RoboCompYoloObjects::TBox &box, const Eigen::Transform<float, 3, Eigen::Affine> &tf, RoboCompYoloObjects::TObjectNames t_objects);
        ...
        static std::vector<PreObject> add_yolo(const std::vector<RoboCompYoloObjects::TBox> &boxes, const Eigen::Transform<float, 3, Eigen::Affine> &tf, RoboCompYoloObjects::TObjectNames t_objects);
